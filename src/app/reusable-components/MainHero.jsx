        ...
        <section className="main-hero rounded-3xl p-[2px] m-4 shadow-lg">
            <div className="flex relative rounded-3xl bg-gradient-to-b from-blue-50 to-blue-300 h-full lg:min-h-[42rem] lg:max-h-svh">
                ...
                <div className="main-hero-cnts p-12 mx-auto my-0 flex flex-col gap-8 items-center justify-center z-10 relative overflow-hidden">
                    ...
                    <h2 className="font-extrabold text-3xl leading-snug lg:text-4xl txt-shadow lg:leading-snug text-transparent bg-gradient-to-br from-blue-600 to-blue-800 bg-clip-text">Coding is a journey of creating,<br/> testing, refining, and repeating.<br/> Let us be your guide.</h2>
                    <p className="text-lg">Amp up your designs with our free tailor-made components and build better, faster.</p>
