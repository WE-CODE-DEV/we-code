...
const SliderPreview = ({ theme, populateThemes }) => {
    const themes =  [{theme: 'dark', priClr: '#1e2022', secClr: '#333539'}, {theme: 'light', priClr: '#fff', secClr: '#cecece'}, {theme: 'custom', priClr: '#ccdff9', secClr: '#60a5fa'}];
    ...
    useEffect(() => populateThemes(themes), []);
