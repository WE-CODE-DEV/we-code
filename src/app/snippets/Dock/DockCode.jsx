        ...
        <div class="dock">
            <nav>
                <ul>
                    ...
                    <li class="scale-3">
                        <a data-title="Achievements">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g stroke="currentColor" stroke-width="1.5">
                                  <path d="m11 8 1.5-1.5v4" stroke-linecap="round" stroke-linejoin="round"/>
                                  ...
                                  <path d="M15.5 22h-7l.34-1.696a1 1 0 0 1 .98-.804h4.36a1 1 0 0 1 .98.804L15.5 22Z" stroke-linecap="round" stroke-linejoin="round"/>
                                  <path d="M18 22H6M17 2.456c.741.141 1.181.297 1.56.765.477.586.452 1.219.401 2.485-.18 4.553-1.2 10.294-6.96 10.294S5.22 10.26 5.038 5.706c-.05-1.266-.075-1.9.4-2.485.476-.586 1.045-.682 2.184-.874A26.374 26.374 0 0 1 12 2c.718 0 1.386.025 2 .068" stroke-linecap="round"/>
                                </g>
                            </svg>                                  
                        </a>
                    </li>
                    <li class="scale-2">
                        <a data-title="Experience">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g stroke="currentColor" stroke-width="1.5">
                                  ...
                                  <path d="M4 21.388h2.26c1.01 0 2.033.106 3.016.308 1.74.359 3.573.402 5.33.118m-.93-3.297c.12-.014.235-.03.345-.047.911-.145 1.676-.633 2.376-1.162l1.808-1.365a1.887 1.887 0 0 1 2.22 0c.573.433.749 1.146.386 1.728-.423.678-1.019 1.545-1.591 2.075m-5.544-1.229a8.176 8.176 0 0 1-.11.012m.11-.012a.998.998 0 0 0 .427-.24 1.492 1.492 0 0 0 .126-2.134 1.9 1.9 0 0 0-.45-.367c-2.797-1.669-7.15-.398-9.779 1.467m9.676 1.274a.524.524 0 0 1-.11.012m0 0a9.274 9.274 0 0 1-1.814.004" stroke-linecap="round"/>
                                </g>
                            </svg>                                  
                        </a>
                    </li>
                    <li class="scale-1">
                        <a data-title="Contact Me">
...
.dock nav ul li.scale-3 a::before {
  position: absolute;
  white-space: nowrap;
...
const jsCode = `
const clickables = document.querySelectorAll(".dock nav ul li");

const resetScales = () => {
  clickables.forEach((c) =>
    c.classList.remove("scale-1", "scale-2", "scale-3")
  );
};
...
clickables.forEach((clickable, index) => {
  clickable.addEventListener("mouseenter", () => {
    ...
    clickable.classList.add("scale-3");
    clickables[index + 1]?.classList.add("scale-2");
    clickables[index + 2]?.classList.add("scale-1");
    clickables[index - 1]?.classList.add("scale-2");
    clickables[index - 2]?.classList.add("scale-1");
  });
});
...
const Dock = () => {
  ...
  return (
    <div className="dock" data-theme="dark">
      <nav>
        <ul>
