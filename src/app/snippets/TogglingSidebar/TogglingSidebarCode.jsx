const darkThemeCSS = `/* Dark Theme */
    --priBg: rgb(30, 32, 34);
    --textClr: #e0e0e0;
    --liBgHover: linear-gradient(to bottom right, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0.05));
    --liBrdrClrHover: rgba(255, 255, 255, 0.2);
    --actionBtnBg: linear-gradient(to bottom right, #52525b, #174ce0);
    --bgDots: radial-gradient(circle, #e0e0e0 10%, transparent 11%), radial-gradient(circle at bottom left, #e0e0e0 5%, transparent 6%), radial-gradient(circle at bottom right, #e0e0e0 5%, transparent 6%), radial-gradient(circle at top left, #e0e0e0 5%, transparent 6%), radial-gradient(circle at top right, #e0e0e0 5%, transparent 6%);
`;

const lightThemeCSS = `/* Light Theme */
    --priBg: #fff;
    --textClr: rgb(30,32,34);
    --liBgHover: background: linear-gradient(to bottom right, rgba(68, 64, 60, 0.1), rgba(68, 64, 60, 0.05));
    --liBrdrClrHover: rgba(68, 64, 60, .2);
    --actionBtnBg: linear-gradient(to bottom right, #52525b, #292524);
    --bgDots: radial-gradient(circle, #292524 10%, transparent 11%), radial-gradient(circle at bottom left, #292524 5%, transparent 6%), radial-gradient(circle at bottom right, #292524 5%, transparent 6%), radial-gradient(circle at top left, #292524 5%, transparent 6%), radial-gradient(circle at top right, #292524 5%, transparent 6%);
`;
...
<body>
    <div class="container">
        <div class="navigation-container">
            <nav class="toggling-navigation">
                <div class="ul-wrapper">
                    <button aria-label="Toggle Navigation">
                        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M8.5 17a1 1 0 0 0 1.707.707l5-5a1 1 0 0 0 0-1.414l-5-5A1 1 0 0 0 8.5 7v10Z"
                                fill="currentColor" />
                        </svg>
                    </button>
                    <ul>
...
.toggling-navigation ul li:hover,
.toggling-navigation ul li:focus{
    background: var(--liBgHover);
    border-color: var(--liBrdrClrHover);
}

.toggling-navigation .ul-wrapper button{
    background: var(--actionBtnBg);
}
...
.toggling-navigation ul li:hover::before,
.toggling-navigation ul li:focus::before{
    background: var(--bgDots);
    background-size: 1em 1em;
}
...
.toggling-navigation ul li:not(:has(a)){
    gap: 1rem;
    display: flex;
    align-items: center;
    overflow: hidden;
